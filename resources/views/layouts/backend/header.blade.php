          ...
          <div class="container">
            <div class="d-flex">
              <a class="header-brand" href="./index.html">
                <h1 class="header-brand-img mb-0 text-uppercase text-warning font-weight-bold">Ran<span class="m-0 text-uppercase text-danger font-weight-bold">Sum</span></h1>
              </a>
            ...
            <div class="row align-items-center">
              ...
              <div class="col-lg order-lg-first">
                <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                  ...
                  <li class="nav-item dropdown">
                    <a href="#" class="nav-link {{ (request()->is('admin/episode')) ? 'active' : '' }} {{ (request()->is('admin/episode/*')) ? 'active' : '' }}"><i class="fe fe-video"></i> Video</a>
                  </li>
                  <li class="nav-item dropdown">
