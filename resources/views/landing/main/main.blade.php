                          ...
                          <div class="col-lg-6">
                              <div class="position-relative mb-3">
                                  <img class="img-fluid w-100"
                                      src="{{ file_exists(public_path('article/' . $news->image)) ? asset('article/' . $news->image) : asset('article/image/2sdkWkMePlOquI.jpg') }}"
                                      style="object-fit: cover;">
                                  <div class="bg-white border border-top-0 p-4">
                                      <div class="mb-2">
                                          <a class="badge badge-primary font-weight-semi-bold p-2 mr-2"
                                              href="">{{ $news->category_name }}</a>
                                          <a class="text-body" href=""><small>{{ $news->release }}</small></a>
                                      </div>
                                      <a class="h4 d-block mb-3 text-secondary font-weight-bold truncate-2"
                                          href="{{url('berita/'.$news->slug)}}">{{ $news->title }}</a>
                                      <p class="m-0 truncate-3">{{$news->subtitle}}</p>
                                  </div>
                                  <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
                                      ...
                                      <div class="d-flex align-items-center">
                                          ...
                                          <small class="ml-3"><i
                                                  class="far fa-comment mr-2"></i>{{ $news->comments_count }}</small>
                                      </div>
                                  </div>
                              </div>
                          </div>
