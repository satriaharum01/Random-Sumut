        ...
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title title-sub">Tambah Category</h3>
                        </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            id="name" name="name" placeholder="Category Baru..."
...
@section('js')
    ...
    <script>
        ...
        function kosongkan() {
            ...
            jQuery(".title-sub").html("Tambah Category");
        ...
        $("body").on("click", ".btn-edit", function() {
            ...
            jQuery(".title-sub").html("Update Category");
        });
    </script>
@endsection
