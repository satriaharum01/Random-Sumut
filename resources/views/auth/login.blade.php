...
<div class="login-container">
    <div class="login-card">
        ...
        <form action="{{route('custom.login')}}" class="login-form" id="loginForm" method="POST" novalidate>
            @csrf
            ...
            <div class="input-group @error('title') error @enderror">
                <input
                    type="password"
                    id="password"
                    name="password"
                ...
                <span class="input-border"></span>
                <span class="error-message @error('title') show @enderror" id="passwordError">
                @error('title')
                {{ $message }}
                @enderror
                </span>
